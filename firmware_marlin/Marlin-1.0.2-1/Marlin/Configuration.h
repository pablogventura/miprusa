...
#define STRING_CONFIG_H_AUTHOR "Pablo Ventura" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "ExNihilo" //tiene sentido, construye desde la nada :-D
...
#define DISABLE_Z false // TODO esto era true en lo de santiago, capaz deberian ser todos true
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -25.5 //restarre aca, acerca el extrusor a la cama
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,8000,283}  // default steps per unit for Ultimaker Santiago tenia {160,160,8000,293}
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 5,100} // X,Y,Z Axis Extend and Retract angles
