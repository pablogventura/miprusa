 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 158 } // antes 100, 100, 400, 158 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.25 // Z offset: -below +above  [the nozzle] restar aca, acerca el extrusor a la cama
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION (0 + 30)
  #define RIGHT_PROBE_BED_POSITION (X_MAX_POS - 30)
  #define FRONT_PROBE_BED_POSITION (0 + 61)
