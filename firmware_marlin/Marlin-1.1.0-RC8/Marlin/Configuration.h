...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //#define  DEFAULT_Kd 440
    ...
    #define  DEFAULT_Kp 30.40
    #define  DEFAULT_Ki 2.15
    #define  DEFAULT_Kd 107.59
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,150}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.25  // Z offset: -below +above  [the nozzle] //restar aca, acerca el extrusor a la cama
