...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  ////#define  DEFAULT_bedKp 10.00 valores originales
  ////#define  DEFAULT_bedKi .023
  ////#define  DEFAULT_bedKd 305.4
  #define DEFAULT_bedKp 202.96 //valores con el autopid
  #define DEFAULT_bedKi 37.54
  #define DEFAULT_bedKd 274.32
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      {1500,1500,1000,10000}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.8  // Z offset: -below +above  [the nozzle] //restar aca, acerca el extrusor a la cama
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION (Y_MIN_POS + 60)
