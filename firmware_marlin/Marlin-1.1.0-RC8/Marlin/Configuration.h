...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.65  // Z offset: -below +above  [the nozzle] //restar aca, acerca el extrusor a la cama
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION (Y_MIN_POS + 30)
