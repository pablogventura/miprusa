...
#define STRING_CONFIG_H_AUTHOR "vector 3D" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,146.5}  // default steps per unit for ultimaker
...
#define ABS_PREHEAT_FAN_SPEED 150   // Insert Value between 0 and 255 (tenia 255)
